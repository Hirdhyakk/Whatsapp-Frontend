            ...
            <div className="pe-3 hover">
                {
                    currentChat?.profilePic && currentChat?.profilePic !== "" ? (
                        <img className="profile-pic" alt="profile-pic" draggable="false" tabIndex="-1" src={currentChat?.profilePic} />
                    ) : (
                        currentChat?.type === "group" ? (
                            <svg viewBox="0 0 212 212" height="40" width="40" preserveAspectRatio="xMidYMid meet" fill="none">
